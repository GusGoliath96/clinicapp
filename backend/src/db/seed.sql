...
--
-- As chaves do JSON seguem em português: são conteúdo da coluna, não estrutura do banco.
INSERT INTO professionals (id, tenant_id, name, license, specialty, color, schedule) VALUES
...
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name, license = EXCLUDED.license, specialty = EXCLUDED.specialty,
  color = EXCLUDED.color, schedule = EXCLUDED.schedule, active = true, updated_at = now();

INSERT INTO patients (id, tenant_id, name, phone, insurance_plan, source, lgpd_consent) VALUES
...
INSERT INTO conversations (id, tenant_id, patient_id, phone, display_name, status, unread, last_inbound_at, last_message_preview) VALUES
...
INSERT INTO messages (id, tenant_id, conversation_id, direction, kind, body, status) VALUES
...
INSERT INTO appointments (id, tenant_id, patient_id, professional_id, kind, insurance_plan, starts_at, ends_at, status, source) VALUES
...
UPDATE patients SET
  social_name = '', rg = '12.345.678-9', birth_date = '1955-03-12', gender = 'F',
  email = 'tania@email.com', tags = '["Idosa","Hipertensa","VIP"]',
  insurance_details = '{"operadora":"Unimed","plano":"Personal","matricula":"008456789012","validade":"12/2026"}',
  address = '{"cep":"01305-000","rua":"Rua Augusta","numero":"200","complemento":"Apto 42","bairro":"Consolação","cidade":"São Paulo","uf":"SP"}',
  emergency_contact = '{"nome":"Carla Felux","tel":"(11) 99999-0000","parentesco":"Filha"}',
  health = '{"tipoSanguineo":"O+","peso":"62 kg","altura":"1.58 m","imc":"24.8","habitos":"Não fuma · não bebe","atividadeFisica":"Caminhada 3x/semana","historicoFamiliar":"Pai: Cardiopatia · Mãe: Diabetes tipo 2","cirurgias":["Catarata (2020)"]}',
  allergies = '["Dipirona","Penicilina"]',
  comorbidities = '["Hipertensão arterial","Osteoartrose"]',
  medications = '["Losartana 50mg 1x/dia","Atenolol 25mg 1x/dia"]'
WHERE id = '00000000-0000-0000-0000-0000000000b1';

UPDATE patients SET
  rg = '23.456.789-0', birth_date = '1961-08-22', gender = 'M', email = 'paulo@email.com',
  tags = '["Recorrente"]', comorbidities = '["Diabetes Tipo 2"]', medications = '["Metformina 500mg 2x/dia"]'
WHERE id = '00000000-0000-0000-0000-0000000000b2';

INSERT INTO documents (id, tenant_id, patient_id, kind, name, status, date) VALUES
...
INSERT INTO exams (id, tenant_id, patient_id, professional_id, name, kind, status, requested_on, resulted_on, report) VALUES
...
INSERT INTO treatments (id, tenant_id, patient_id, professional_id, name, kind, total_sessions, completed_sessions, status, price, starts_on) VALUES
...
INSERT INTO clinical_notes (id, tenant_id, patient_id, professional_id, appointment_id, kind, content, noted_at) VALUES
...
INSERT INTO insurance_plans (id, tenant_id, name, ans_code, payment_term_days, default_split, active) VALUES
